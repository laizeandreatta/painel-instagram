...
import { useLeads, RECURSO_CONSULTORIA } from "@/lib/useLeads";
    ...
    <div className="px-6 py-7 md:px-10">
      <div className="mb-7 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-ink/50">
            Leads da consultoria Valore: da venda confirmada na Hubla até a
            consultoria marcada com a Laize.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-line bg-white px-4 py-10 text-center text-sm text-ink/40">
          Nenhum lead cadastrado ainda. Assim que uma venda for confirmada na
          Hubla, o lead vai aparecer aqui automaticamente — ou cadastre um
          manualmente com o botão &quot;Novo lead&quot;.
        </div>
      ) : (
        <LeadKanbanBoard
          leads={leads}
